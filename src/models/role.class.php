<?php
	...
	class Role
	{
		...
		const TBL_ORGANIZATION = "table=Role";
		...
		public function getRoleNameWithId($roleID)
		{
			$url = self::DB_URL . self::TBL_ORGANIZATION . self::ROLE_ID . $roleID;
		...
		private function convertXMLDataToArray()
		{
			...
			//error_log(json_encode($obj->roleID->name));

			return (string) $obj->roleID->name;
		}
